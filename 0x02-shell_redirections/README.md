1. question one is abt displaying the confused smiley and backclash is used to display the message as the quotation mark is closed so inorder to prevent that backslash is used 
